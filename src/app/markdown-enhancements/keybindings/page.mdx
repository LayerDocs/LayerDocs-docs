...
The **`.keybinding \{keys\}`** [layerdocs-stdlib/com.layerdocs.stdlib.module.MiscElements/keybinding.html](https://layerdocs.com/docs/layerdocs-stdlib/com.layerdocs.stdlib.module.MiscElements/keybinding.html) function displays a keyboard shortcut or key combination.
