...
The **`.icon \{name\}`** [layerdocs-stdlib/com.layerdocs.stdlib.module.Icon/icon.html](https://layerdocs.com/docs/layerdocs-stdlib/com.layerdocs.stdlib.module.Icon/icon.html) function displays a pixel-perfect icon by its name.

```layerdocs
.examplemirror
    LayerDocs is on .icon \{github\}
