...
You can use the `.emoji` [layerdocs-stdlib/com.layerdocs.stdlib.module.Emoji/emoji.html](https://layerdocs.com/docs/layerdocs-stdlib/com.layerdocs.stdlib.module.Emoji/emoji.html) function with a shortcode:
