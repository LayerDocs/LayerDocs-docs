# Block vs. inline calls




**Functions** are the key feature of LayerDocs, distinguishing it from other Markdown dialects and many other markup languages. They are loaded from external libraries, either native (e.g., [standard library](https://github.com/layerdocs/layerdocs/tree/main/layerdocs-stdlib/src/main/kotlin/com/layerdocs/stdlib)) or defined in a LayerDocs source, and come in different categories:
...
To understand how chaining works, consider this simpler example (see [*Variables*](variables) to learn more about variables):
