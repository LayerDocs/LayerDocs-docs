...
The `param1 param2 param3:` portion is the *header* of the lambda, where you define parameter names. You can access their values as if you were dealing with [variables](variables):
...
- When the lambda expects 0 parameters (such as in [conditional statements](conditional-statements))
