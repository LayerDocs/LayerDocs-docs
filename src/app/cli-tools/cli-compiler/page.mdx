...
For all available options, refer to the [CLI options](cli-options) page.
...
> 
> - The following requires `project-read`, because the [media storage system](media-storage) is turned on for HTML output, and the compiler needs to handle the image file:
>   ```markdown
>   ![Image](/logo.png)
>   ```
>   
