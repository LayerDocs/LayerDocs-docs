...
Among the nodes generated from the [Parsing](pipeline---parsing) stage, those of type `FunctionCallNode(context, name, arguments)` represent [function calls](syntax-of-a-function-call).
...
Before addressing the expansion itself, we should understand how data is exchanged among functions. LayerDocs functions, either explicitly or implicitly, always return a [`Value`](https://github.com/iamgio/layerdocs/tree/main/layerdocs-core/src/main/kotlin/eu/iamgio/layerdocs/function/value), a type-checked object wrapper.
