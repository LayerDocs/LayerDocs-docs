...
- Heading hierarchy, used for the [table of contents](table-of-contents)
- [Numbering](numbering): each heading, figure, and other numbered element is assigned a unique number based on its location in the heading hierarchy
