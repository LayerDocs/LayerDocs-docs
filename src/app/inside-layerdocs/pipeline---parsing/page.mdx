...
Continuing with the metaphor introduced in [Lexing](pipeline---lexing), once the nouns, verbs, and adjectives are extracted from a sentence, our brain is responsible for linking them together to build information out of them.
...
!(200)[Recursive parsing](/logo.png)
