...
[Inclusion](including-other-layerdocs-files) via `.include` and `.includeall` evaluates other LayerDocs source files.
...
[Subdocuments](subdocuments) are independent and referenceable source files.
