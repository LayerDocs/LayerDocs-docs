...
> Reference: [Project Creator](cli-project-creator)
...
> Reference: [Document types](document-types)
...
See [Themes](themes) for a complete list of available themes.



## Compiling

> Reference: [Compiler](cli-compiler)
...
See the [PDF export](pdf-export) page for more information about PDF export and its requirements. If you installed LayerDocs using a package manager or the install script, you should be ready to go.
...
> References: [Image size](image-size), [Size](sizes)
...
> Reference: [TeX formulae](tex-formulae)
...
!(650)[Equations](/logo.png)

## Function call syntax

> Reference: [Syntax of a function call](syntax-of-a-function-call)
...
> Reference: [Declaring functions](declaring-functions), [Boxes](box)
...
!(650)[Custom element](/logo.png)

Congratulations! You've created your first reusable element using [boxes](box). Many more layout tools are available, such as [containers](container) and [stacks](stacks).

For advanced styling of custom elements, you can use CSS rules. See [CSS](css) for more information.
...
> This YAML-like syntax represents a [dictionary](dictionary) data type.

!(650)[Numbering](/logo.png)
...
> Reference: [Table of contents](table-of-contents)
...
> Reference: [Cross-references](cross-references)
...
```markdown
!(50%)[Logo](/logo.png) \{#logo\}

The LayerDocs logo is shown in .ref \{logo\}.
```

!(650)[Cross-reference](/logo.png)

See [Cross-references](cross-references) to learn how to add IDs to other elements, such as sections, tables, equations, and code blocks.



## Page margins and counter

> References: [Page format](page-format), [Page margin content](page-margin-content), [Page counter](page-counter)
...
The `.pagemargin` function can add any kind of content to each page. See [Page margin content](page-margin-content) for all available margin positions.

### Persistent headings

> Reference: [Persistent headings](persistent-headings)
...
> Reference: [Inclusion vs. subdocuments](inclusion-vs-subdocuments)

There are two main ways to split a large document into multiple source files: inclusion and subdocuments.

### Including files

> Reference: [Including other LayerDocs files](including-other-layerdocs-files)
...
> Reference: [Subdocuments](subdocuments)
...
!(650)[Subdocuments](/logo.png)


## Static assets

> Reference: [HTML static assets](html-static-assets)
