...
[Theme contributions](https://github.com/layerdocs/layerdocs/tree/main/layerdocs-html/src/main/scss) are welcome.

Please make sure themes work well with all three document types before submitting. The [Mock document](https://github.com/layerdocs/layerdocs/tree/main/mock#readme) is a great way to test themes against a variety of different elements.
