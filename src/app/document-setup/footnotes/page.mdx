...
```layerdocs
.exampleoutput \{![Footnote](/assets/footnotes/basic.png)\}
...
```layerdocs
.exampleoutput \{![Footnote multi-reference](/assets/footnotes/multi-reference.png)\}
    This is a footnote reference[^first: This is the definition],
...
```layerdocs
.exampleoutput \{![Footnote formatting](/assets/footnotes/formatted.png)\}
    This is a footnote reference[^first: This is the **definition**.]
...
Footnotes are numbered by default with decimal numbers, starting from 1. To apply a different numbering style, such as Roman numerals, use the `.numbering` function. See [*Numbering*](numbering) for more information.

```layerdocs
.exampleoutput \{![Footnote Roman numbering](/assets/footnotes/roman-numbering.png)\}
    .numbering
        - footnotes: i
...
Footnotes render differently depending on the document type. See [*Document types*](document-types) for more information.
