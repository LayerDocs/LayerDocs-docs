...
- In `paged` documents, a special area of each page is reserved for margins:
  ...
  !(_*600)[Paged margin areas](/logo.png)
...
```layerdocs
.exampleoutput \{![Fixed positions](/assets/page-margin-content/fixed-positions.png)\}
    .pagemargin \{topright\}
...
```layerdocs
.exampleoutput \{![Scoped page margins](/assets/page-margin-content/scoped-margins.png)\}
...
```layerdocs
.exampleoutput \{![Scoped page margins](/assets/page-margin-content/scoped-overwrite.png)\}
    ...
...
```layerdocs
.exampleoutput \{![Mirror positions](/assets/page-margin-content/mirror-positions.png)\}
...
```layerdocs
.exampleoutput \{![Page footer](/assets/page-margin-content/footer.png)\}
...
A page margin can host a page counter. See [Page counter](page-counter) for more information.
