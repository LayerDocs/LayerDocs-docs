...
The **`.paragraphstyle`** [layerdocs-stdlib/com.layerdocs.stdlib.module.Document/paragraphstyle.html](https://layerdocs.com/docs/layerdocs-stdlib/com.layerdocs.stdlib.module.Document/paragraphstyle.html) function allows you to override the global style of paragraphs.
...
```layerdocs
.exampleoutput \{![Customized](/assets/paragraph-style/customized.png)\}
