...
The function takes a [Dictionary](dictionary) as its value, where each key is the author's name and values are nested dictionaries containing author information. There are no constraints on the information entries you can use.
...
The `.dockeywords` function sets the document's keywords as an [iterable](iterable).
