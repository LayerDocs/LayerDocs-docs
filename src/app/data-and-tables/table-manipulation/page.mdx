...
This page describes table manipulation functions [layerdocs-stdlib/com.layerdocs.stdlib.module.TableComputation](https://layerdocs.com/docs/layerdocs-stdlib/com.layerdocs.stdlib.module.TableComputation) that allow you to sort, filter, and compute values from any kind of table, including plain Markdown ones and those [loaded from CSV](file-data.qd#table-from-csv).
