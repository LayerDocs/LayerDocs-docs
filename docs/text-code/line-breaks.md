...
LayerDocs follows the standard Markdown specification, so you can create soft line breaks by ending a line with two or more spaces:
...
&gt; Some Markdown users suggest using explicit `&lt;br&gt;` HTML tags. LayerDocs, however, [discourages direct HTML injection](html.qd).

As an alternative, LayerDocs provides the **`.br`** function for explicit line breaks.
