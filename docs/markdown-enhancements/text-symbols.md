...
.docname &#123;Text symbols&#125;
.include &#123;docs&#125;

LayerDocs features automatic text replacement for commonly used UTF-8 symbols.
...
.examplemirror
    "LayerDocs"--a typesetting system--supports automatic text replacements.
