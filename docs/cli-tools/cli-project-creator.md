...
The **project creator** is a CLI project wizard that makes it fast to set up a new LayerDocs project.

**`layerdocs create [directory]`** launches the wizard and generates the project files in the given directory (it will
...
| Data                      | Additional info                                    | Corresponding option | Generated LayerDocs function                  |
|---------------------------|----------------------------------------------------|----------------------|-----------------------------------------------|
