...
The **`.pageformat`** .docslink &#123;layerdocs-stdlib/com.layerdocs.stdlib.module.Document/pageformat.html&#125; function configures the page format. All its parameters are **optional**, and if left unset, they delegate their default value to the underlying renderer depending on the document type.
