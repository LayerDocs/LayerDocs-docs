...
LayerDocs introduces a compact `[^label: definition]` syntax that allows you to define footnotes directly at their reference point.
...
LayerDocs also supports the standard footnote syntax provided by many Markdown flavors.
