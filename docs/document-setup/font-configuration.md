...
.docname &#123;Font configuration&#125;
.include &#123;docs&#125;

The **`.font`** .docslink &#123;layerdocs-stdlib/com.layerdocs.stdlib.module.Document/font.html&#125; function overrides the global font configuration.
...
Multiple `.font` calls create overlapping font configurations. Each font configuration overrides the previous one as long as it contains glyphs for the characters being rendered. Otherwise, LayerDocs uses the previous font configuration as a fallback.
