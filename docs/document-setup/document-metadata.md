...
You can set document information using the following functions. By convention, you should call these functions at the beginning of your LayerDocs source.

| Name              | Accepts                                                                                                                                                                                                                                                                                                                                                                                                                                      | Default                       |
|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|
| `.docname`        | The name of the document.                                                                                                                                                                                                                                                                                                                                                                                                                    | `Untitled LayerDocs Document` |
...
.exampleoutput &#123;This document is named **LayerDocs**!&#125;
    .docname &#123;LayerDocs&#125;
