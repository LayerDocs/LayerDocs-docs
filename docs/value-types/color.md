...
When you write a color in a code span (wrapped in backticks), LayerDocs automatically displays a small preview box next to it. This works for all color formats except named colors.